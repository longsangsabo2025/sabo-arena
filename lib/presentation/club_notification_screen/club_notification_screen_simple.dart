...
class ClubNotificationScreenSimple extends StatefulWidget {
  ...
  const ClubNotificationScreenSimple({super.key, this.clubId});

  @override
  State<ClubNotificationScreenSimple> createState() =>
      _ClubNotificationScreenSimpleState();
}

class _ClubNotificationScreenSimpleState
    extends State<ClubNotificationScreenSimple> {
