...
class RealTimeTournamentService {
  ...
  /// Handle matches table updates (results, bracket progression) - Legacy method
  /// @deprecated Use subscription manager callbacks instead
  @Deprecated('Use subscription manager callbacks')
  void _handleMatchUpdateLegacy(PostgresChangePayload payload) {
    try {
  ...
  /// Handle tournament participants updates (registration, withdrawal) - Legacy method
  /// @deprecated Use subscription manager callbacks instead
  @Deprecated('Use subscription manager callbacks')
  void _handleParticipantUpdateLegacy(PostgresChangePayload payload) {
    try {
      final eventType = payload.eventType;
      final newRecord = payload.newRecord;
      final oldRecord = payload.oldRecord;
