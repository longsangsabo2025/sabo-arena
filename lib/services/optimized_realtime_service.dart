...
class RealtimeEvent {
  ...
  @override
  String toString() => '🔄 $type[$contextId] at ${timestamp.millisecondsSinceEpoch}';
}
...
class OptimizedRealtimeService {
  ...
  Stream<RealtimeEvent> subscribeToEvent(RealtimeEventType type, [String? contextId]) {
  ...
  Future<void> sendTypingIndicator(String roomId, String userId, bool isTyping) async {
    final channelId = 'room_$roomId';
  ...
  Future<void> dispose() async {
    ...
    final futures = _channels.keys.map((channelId) => 
        _disconnectChannel(channelId).timeout(
