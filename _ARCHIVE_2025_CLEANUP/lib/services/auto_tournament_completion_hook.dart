...
class AutoTournamentCompletionHook {
  ...
  static Future<void> _logCompletionError(
    ...
    try {
      ...
      ProductionLogger.error('Failed to log completion error', error: e, tag: 'AutoTournamentCompletionHook');
    }
  }
  ...
  static Future<void> checkPendingCompletions() async {
    try {
      ...
      ProductionLogger.error('Failed to check pending completions', error: e, tag: 'AutoTournamentCompletionHook');
    }
  }
